...
class RepositoryModule {
    ...
    @Provides
    fun provideAllNewsFromRestApiNetworkOrFromRoom(weatherDatabase: WeatherDatabase, weatherRepositoryApi: WeatherRepositoryApi, dbMapper : DbMapper) : WeatherRepository {
