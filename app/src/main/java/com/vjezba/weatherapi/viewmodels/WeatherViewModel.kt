...
class WeatherViewModel @ViewModelInject constructor(
    ...
    private val _weatherMutableLiveData: MutableLiveData<DataState<*>> = MutableLiveData()

    val weatherList: LiveData<DataState<*>> = _weatherMutableLiveData
    ...
    private fun getWeatherFromNetwork(latitude: Double, longitude: Double) {
        weatherRepository.getWeatherData(latitude, longitude)
            ...
            .toObservable()
            .subscribe(object : Observer<DataState<*>> {
                override fun onSubscribe(d: Disposable) {
                    compositeDisposable.add(d)
                }

                override fun onNext(newWeatherData: DataState<*>) {
        ...
        weatherRepository.getWeatherDataByCityName(cityName)
            ...
            .onErrorResumeNext { throwable: Throwable ->
                return@onErrorResumeNext ObservableSource {
                    ...
                    _weatherMutableLiveData.value?.let {
                        _weatherMutableLiveData.value = DataState.Error(throwable as java.lang.Exception)
                    }
...
//            }
            .subscribe(object : Observer<DataState<*>> {
                ...
                override fun onNext(response: DataState<*>) {
